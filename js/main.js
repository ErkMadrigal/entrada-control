...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            let codigoLimpio  = res.code.split("\n")[0].toString();
            if (codigoLimpio.length>13){
                swal({
                    title : "Error",
                    text : "La matricula debe de tener unicamente 13 dígitos",
                    icon : "error",
                    buttons : false,
                    timer: 4000
                });
            }else{
                location.href = url+"php/redireccionar-alumno.php?matricula=" + codigoLimpio;   
            }
        },
